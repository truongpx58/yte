	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2-1">
			<div class="panel panel-default">
				<div class="panel-heading">Cập nhật Đái tháo đường</div>
				<div class="panel-body">
					@if (count($errors) > 0)
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/bn/benhdtd') }}">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Chỉ số đường huyết</label>
							<div class="col-md-6">
								<input type="text" class="form-control" name="duongHuyet">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Bạn đã ăn gì trong khoảng 6 tiếng trước</label>
							<div class="col-md-6">
